      ...
      >
        <div>
          ...
          <p className="text-[#768EA7] text-base !mb-4">
            Full job details would appear here, including description,
            requirements, benefits, and application process.
          </p>
          <button className="h-10 cursor-pointer bg-blue-500 !text-white !text-sm !font-medium px-4 py-2 rounded-lg hover:bg-blue-500 transition" onClick={()=>setOpen(false)}>
            Close
          </button>
        </div>
      </Modal>
